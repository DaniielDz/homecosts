  ...
  return (
    <div className="h-[calc(100dvh-64px)] w-full bg-[url('/homeBgImage.webp')] bg-cover bg-center relative">
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 z-30 px-2.5 md:px-5">
        ...
        <p className="text-center text-xl text-gray-200">1,000+ home improvement calculators for remodeling, repairs, and installations. <br /> Get localized costs for materials, time, and labor in your ZIP code.</p>
        <SearchForm
