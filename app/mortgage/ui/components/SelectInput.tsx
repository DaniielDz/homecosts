        ...
        <div className="flex flex-col w-full">
            ...
            <div className="relative">
                <select
                    ...
                    className="block w-full appearance-none border border-gray-300 rounded-md py-2 pl-3 pr-8 text-gray-700 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                >
                    {options.map((opt) => (
